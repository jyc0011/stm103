...
#define PROCESSOR PROCESSOR_STM32F103C8T6 //PROCESSOR_STM32F103RCT6//PROCESSOR_STM32F103C8T6 //PROCESSOR_STM32F103RCT6 //

#if (PROCESSOR == PROCESSOR_STM32F103C8T6)
#define MCU_MODULE_VER 			35 //orginal //39 //M35
...
#define USART2_FOR USART2_FOR_LIN//USART2_FOR_GPS //
...
#define DEBUG_UART_INDEX  1 //-- Datong Module //2//3//2//1// 6
#else
...
#define 	I2C_SPEED 					400000 //400Kbps
...
#else
#define USE_SPIX USE_SPI1 //-STM32F103RCT6
#endif
...
#define USE_EXTI4 				USE_EXTI4_LIS3MDL//0 //USE_EXTI4_GPSPPS //
...
#define DISPLAY_ON DISPLAY_ON_OLED_I2C

//(9) Which Motors
#define MOTOR_FOR_VID29 		1
#define MOTOR_FOR_DRV11873 		2
#define MOTOR_FOR_DRV8313		3
#define MOTOR_FOR_DRV8833		4
#define MOTOR_FOR_A3967			5
#define MOTOR_FOR_MCP8063		6
#define MOTOR_FOR_TB6612		7
#define MOTOR_FOR_SERVO			8
#define MOTOR_FOR MOTOR_FOR_DRV8313 //MOTOR_FOR_DRV11873//MOTOR_FOR_SERVO //MOTOR_FOR_VID29
