...
void RTC_DS3231_Adjust(struct _DateTime *dt)
{
	  ...
	  DS3231_writeRegister8(0x00, 0x00);
...
#endif
void DS3231_setup(struct _DateTime *dt)
{
  // Initialize DS3231
  printf("Initialize DS3231\r\n");

  // If date not set
  if (!RTC_DS3231_isrunning()) //==1 --> Osc Not Running.... Clock Hold...
  {
	  printf("DS3231 is fresh\r\n");
...
void DS3231rtc_loop()
{
  ...
  // For leading zero look to DS3231_dateformat example
	while(1){
		...
		sprintf(str,"%02u:%02u:%02u",DateTime.hh,DateTime.mm, DateTime.ss);
